...
\begin{innerlist}
  \item Compared the predictive capabilites of different Bayesian hierarchical models to forecast influenza outbreaks \\
\end{innerlist}
...
\begin{innerlist}
  \item Data from a multigenerational study was used to tease out relationship dynamics in young adults \\
\end{innerlist}
...
\begin{innerlist}
  \item Completed Math 447: Introduction to Parallel Computing
...
%%%%%%%%%% VSMs %%%%%%%%%%%%%
\section{Veterinary Services Memoranda (VSM)}

\href{https://www.aphis.usda.gov/sites/default/files/memo_800_110.pdf}{VSM 800.110}: Label Warnings Concerning Bovine Rhinotracheitis Vaccine, Modified Live Virus, and Bovine Virus Diarrhea Vaccine, Modified Live Virus, for Pregnant Cows or Calves Nursing Pregnant Cows \\

\href{https://www.aphis.usda.gov/sites/default/files/memo800-124.pdf}{VSM 800.124}: Guidelines for Potency Specifications of Biological Products Administered to Animals\\
...
%%%%% Awards %%%%%
\section{Awards}
\textbf{Center for Veterinary Biologics (CVB), APHIS, USDA}
\begin{innerlist}
  \item Individual Cash Award NRB (Not Ratings Based) \hfill {Sep 2021}
  \item Individual Cash Award NRB (Not Ratings Based) \hfill {Sep 2021}
  \item Individual Cash Award NRB (Not Ratings Based) \hfill {Aug 2023} \\
\end{innerlist}

\textbf{Iowa State University}
\begin{innerlist}
  \item Alliance for Graduate Education and the Professoriate Fellowship \hfill {Aug 2013 - June 2018} \\
\end{innerlist}
...
\textbf{CDC}: Flusight Annual Conference \hfill {\textbf{Sep 2018}}\\
Atlanta, GA
\begin{innerlist}
  \item Bayesian Hierarchical Models and Influenza Modeling \\
\end{innerlist}



\section{Activities}
\textbf{STAT-ers}: Statistics graduate student organization \hfill {\textbf{Aug 2013 - May 2019}}\\
Iowa State University
\begin{innerlist}
...
\textbf{StatCom}: Statistics in the Community \hfill {\textbf{Aug 2015 - May 2019}}\\
Iowa State University
\begin{innerlist}
...
\textbf{Meeker Elementary} \hfill {\textbf{2021-2022}}\\
Ames, IA
\begin{innerlist}
  \item Help facilitate game nights for the community 
  \item Helped run the walk-a-thon weekly events for the school children \\
\end{innerlist}

\textbf{King Chavez High School} \hfill {\textbf{2025}}\\
San Diego, CA
\begin{innerlist}
  \item Presented to various math course about the field of statistics and job paths
\end{innerlist}
