...
\begin{innerlist}
  \item TA: Run/assist with labs, office hours, and grading for STAT 101 (Principles of Statistics), STAT 401 (Statistical Methods for Research Workers), STAT 544 (Graduate-level Bayesian Statistics)
...
\begin{innerlist}
  ...
  \item Tutor: Worked at the Math Deptartment Tutoring Center where helped students from algebra through the calculus series
  \item Instructor: Run MATH 75 \& MATH 85
\end{innerlist}
