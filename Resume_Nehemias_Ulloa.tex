...
Iowa State University, \textit{Expected:} June 2019 
...
\begin{innerlist}
  \item R Shiny Developer Intern: Worked with statisticians within the company to develop client reports with R Shiny and other tools. Helped create and improve reporting templates to standardize reports across clients. Researched new Shiny features which lead to new Shiny apps and documents for others to use.
\end{innerlist}
...
\begin{innerlist}
  \item TA: Helped run MATH 75 (Developmental Mathematics I) \& MATH 85 (Developmental Mathematics II)
  \item Math Department Tutoring Center: Tutored students from algebra through the calculus series
...
\begin{innerlist}
  \item RA: Investigated methods of fitting a penalized broken cubic spline and compared using AIC, AICcorr, BIC, CV, and GCV criteria’s to the RSE\\
\end{innerlist}
%
