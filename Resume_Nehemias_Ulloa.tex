...
\begin{innerlist}
  \item Worked with scientists to create statistical methods for new assay technologies
...
\begin{innerlist}
  \item Maintained and cleaned 10 datasets for a \verb|R| package
  \item Created scripts to automoatically create figures and tables for grant reports \\
\end{innerlist}
