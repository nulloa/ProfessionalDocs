...
\begin{innerlist}
  \item Collaborated with scientists to create regulations for new assay technologies
  \item Collaborated with regulators to create regulations for emerging diseases
  \item Evaluated experimental designs and their datasets from vaccine safety and efficacy trials
  ...
  \item Trained junior staff and provided them advice on statistical procedure
...
\begin{innerlist}
  \item Evaluated over 400 experimental designs and their datasets from vaccine safety and efficacy trials
...
\begin{innerlist}
  ...
  \item Created new and improved reporting templates to standardize reports across clients
  \item Researched new Shiny features for new Shiny applications and documents \\
