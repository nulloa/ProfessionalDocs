...
\section{Position}
Interdisciplinary: Mathematical Statistician, Statistical Biologist, Computer Scientist 
...
\textbf{Iowa State University} \hfill {\textbf{Aug 2013 - May 2018}} \\
Ames, IA \\
\textbf{Teaching Assistant}
\begin{innerlist}
  \item Ran/assisted with labs
  \item Held office hours
  \item Grading homework and labs
  \item Courses: STAT 101 (Principles of Statistics), STAT 330 (Probability and Statistics for Computer Science), STAT 401 (Statistical Methods for Research Workers), STAT 544 (Graduate-level Bayesian Statistics)
\end{innerlist}
...
\begin{innerlist}
  ...
  \begin{innerlist}
    \item Learned parallel computing using C with MPI, R with Snow, and Matlab
  \end{innerlist}
  \item Team collaborated with the Department of Natural Resources of Maryland to identify trouble areas of the Chesapeake Bay using different statistical methods and ranking systems.
\end{innerlist}
...
\textbf{Programming}:  \verb|R|, SAS, C++, SPSS, MPLUS, Git, \LaTeX \\
...
Being from the west coast, I have come to appreciate Ames. My wife and I have incorporated ourselves into the community. I enjoy riding my bike around town and playing in the soccer and ultimate frisbee summer parks and recreation leagues.
